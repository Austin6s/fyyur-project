...
class Availability(db.Model):
    ...
    artist = db.relationship(
        "Artist",
        backref=db.backref("availability", lazy=True, cascade="all, delete-orphan"),
    )
...
class Album(db.Model):
    ...
    artist = db.relationship(
        "Artist", backref=db.backref("albums", lazy=True, cascade="all, delete-orphan")
    )
    songs = db.relationship(
        "Song", backref="album", lazy=True, cascade="all, delete-orphan"
    )
...
def show_venue(venue_id):
    ...
    data = {
        ...
        "name": venue.name,
        "genres": (
            venue.genres.split(",") if venue.genres else []
...
def show_artist(artist_id):
    ...
    availability = [
        {"id": a.id, "start_time": str(a.start_time), "end_time": str(a.end_time)}
...
@app.route(
    "/artists/<int:artist_id>/availability/<int:avail_id>/delete", methods=["POST"]
)
...
def add_song(album_id):
    ...
    try:
        ...
        artist_id = album.artist_id  # Store before session close
